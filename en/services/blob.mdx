...
description: "Discover the innovations and robustness of VirtusCloud by exploring the serverless storage capabilities."
icon: "database"
---
...
**VirtusCloud**, an advanced technological platform, stands out for providing comprehensive support for various types of solutions. This article delves into the features and capabilities of serverless storage on **VirtusCloud**.
...
<CardGroup cols={2}>
    ...
    <Card title="Zero Management Overhead" icon="server">
        Simplify your workflow by eliminating the need for complex setup procedures. Just upload your assets, and VirtusCloud takes care of the rest. Relax and focus on building your applications.
    </Card>
...
<Info>When your plan expires, actually nothing happens. Only in the next month, VirtusCloud Blob Billing will be enabled.</Info>
<Warning>All prices are in Brazilian Real (R$). To use VirtusCloud Blob Storage, you need to have a valid account with a paid plan.</Warning>

## Supported File Types
VirtusCloud supports a wide range of file types, making it a versatile solution for various types of applications. Here's a list of the main file types supported by VirtusCloud:
...
<Note> If you have a specific file type that you'd like to use with VirtusCloud, please [contact us](/contact).</Note>

## How to Host My Archive on VirtusCloud?
<Steps>
  <Step 
  
  title="Initial Setup" icon="file">
    The first step to host your asset on **VirtusCloud** is to upload your file into the [put endpoint](/blob-reference/endpoint/put). This endpoint allows you to upload your file to the serverless storage.    
  </Step>
  <Step 
...
We've conducted extensive benchmarks to ensure that **VirtusCloud** is the fastest and most reliable serverless storage solution. Here are some of the key findings from our benchmarks:
...
In VirtusCloud tests, using our infrastructure, in [Tampa, Florida](/platform/overview#our-secure-infrastructure).<br/>
