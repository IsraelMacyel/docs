...
Navigate to the file manager and locate the `virtuscloud.app/config` file.
...
If you are already using the maximum available RAM based on your current plan, consider upgrading to a higher plan by visiting the [plans page](https://virtuscloud.app/pricing).
