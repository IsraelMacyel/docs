...
The CPU allocated to your application is determined by your current plan. To address this, consider upgrading to a higher plan on the [plans page](https://virtuscloud.app/pricing). Alternatively, optimize your application to reduce CPU usage.
