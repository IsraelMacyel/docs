---
title: "How to create your virtuscloud.app config file"
sidebarTitle: "Config file"
icon: "gear-complex-code"
description: "Learn how to create your VirtusCloud configuration file"
---

## Configuration file? What is it? 🤔
The configuration file is a file that contains the parameters of your application, such as the main file, memory, version, and other parameters. This file is used to configure and deploy your application on the VirtusCloud platform.

## Creating the configuration file
It's very simple to create the configuration file, just create a file with the name `virtuscloud.app` or `virtuscloud.config` and put the configuration parameters inside it.

<Steps>
    <Step title="Select extension">
        The configuration file can have two extensions: **.app** or **.config**. You can choose the extension you prefer. Tip: use **.app** to help promote VirtusCloud (virtuscloud.app). 😂
...
<Steps>
    ...
    <Step title="MEMORY [*]" icon="memory">
        The **MEMORY** parameter is used to define the amount of memory that your application will use on the VirtusCloud platform.
        ```systemd
        MEMORY=256
        ```
    ...
    <Step title="SUBDOMAIN" icon="globe">
        ...
        <Note>Website url will be: mysite.virtusapp.cloud</Note>
    </Step>
    <Step title="START" icon="play">
        ...
        START=npm run start
        ```
        <Info>This parameter has maximum of **256 characters**.</Info>
        <Info>This parameter **ignores** the MAIN parameter, which is used to join VirtusCloud's standardized initialization commands.</Info>
        <Info>Applications uploaded after June 19, 2025 can edit this field without uploading it again</Info>
    </Step>
</Steps>
...
<Info>Website url will be: mysite.virtusapp.cloud</Info>
