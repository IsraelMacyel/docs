---
title: "Changelog"
description: "Discover the latest news and improvements in Virtus Cloud. Follow product releases, performance optimizations, and much more."
---
...
<Update label="December 30, 2025" description="New Look, Secrets Improvements, LGPD and Optimizations">
  ...
  * **VIRTUSCLOUD\_APP\_ID:** Automatic injection of this ENV with the application ID.
  ...
  * **Postgres:** PostgreSQL databases now start with the `virtuscloud` database created by default, avoiding connection errors for beginners.
...
<Update label="August 2, 2025" description="General Platform Improvement">
  ...
  * Virtus is going **against the market**: no charges, no hassle.
...
<Update label="June 14, 2025" description="Security and Performance">
  ...
  * **Application Log Limitation:** The maximum number of logs per category (logs/crash) in `.virtuscloud` files has been reduced from 10 to 5.
...
<Update label="June 4, 2025" description="API – Workspaces">
  ...
  * `DELETE /v2/workspaces/members`: Removes a member from the workspace.
  ...
  Workspaces now adopt Virtus's unique ID model (40 characters).

  Virtus no longer deletes a workspace when its creator's plan expires.
...
<Update label="February 24, 2025" description="Discord Connection">
  **Discord Connection**
  ...
  \*as this is a test connection, Virtus may reset the connection in case of failure during this authorization period 😄
</Update>
