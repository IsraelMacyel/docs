...
`app.envs` exposes the [`EnvsModule`](https://github.com/virtuscloudofc/sdk-api-js/blob/main/src/modules/envs.ts), which lets you manage the `KEY=value` pairs your application sees at runtime.
