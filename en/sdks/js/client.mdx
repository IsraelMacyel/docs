---
title: "Client"
description: "The main object is the VirtusCloudAPI object, instantiated with an API key. This object signifies a connection to the VirtusCloud service and serves as an interface for interacting with different service aspects."
---

```bash
npm i @virtuscloud/api
```
