...
description: "Learn how to configure your domain on VirtusCloud"
---
...
## Configuring your domain on VirtusCloud

- Choose the site you want to configure the domain for in the [dashboard](https://virtuscloud.app/dashboard), then go to the **Settings** option and enter your domain in place of "example.com."
<Frame>
  <img src="/images/articles/cloudflare/domain-setup.png" style={{ borderRadius: '0.2rem' }} />
</Frame>

- Now that the domain is configured on VirtusCloud, go back to Cloudflare, select your domain, and choose the DNS option.
- Finally, point your domain to "cname.virtusapp.cloud" with the type "CNAME", replacing "name" with your domain, and another with the type TXT with the value that will appear in "DNS Configuration" after clicking "save".
<Frame>
...
- If you receive the Cloudflare 1015 error, it means your domain is not configured correctly. Check your domain configuration and ensure it is correctly pointed to VirtusCloud. If the issue persists, [contact our team](/company/support).