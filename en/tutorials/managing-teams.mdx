---
title: "Managing Your Teams on VirtusCloud"
...
- Before you start, you will need to create an account on VirtusCloud, which can be done through the [sign up page](https://virtuscloud.app/signup). You can use your email to create an account.
- Finally, you need to have a paid plan active on your account. You can view our plans and purchase one [here](https://virtuscloud.app/pricing).

## Creating Your Team

To create your team, you should go to the [dashboard](https://virtuscloud.app/dashboard), click on your profile and choose the "Create a Team" option. Finally, just choose the name of your team and confirm. Thus, it will be created and you can access it by selecting your profile again and choosing the desired team.
<Frame>
...
<Steps>
  <Step title="First Step" icon="check">
    Ask the user you want to add to access the [config](https://virtuscloud.app/account/security) page and trigger the `request team code` button. They should then send you the generated account code. Remember that this code can only be used once and expires after **5 minutes**.
  </Step>
  <Step title="Second Step" icon="star">
    Access the [dashboard](https://virtuscloud.app/dashboard), navigate to your profile, and select the team where you want to add the user. Then, go to the "Members" tab, click on the "Invite a member" button, and enter the user's account code you wish to invite.
<Frame>
...
<Note>
 Only the Admin role can view files such as `.env` `.env.production` and configuration file (`virtuscloud.app/.config`)
</Note>
