...
description: "This documentation provides a comprehensive overview of the POST /v1/objects endpoint of the VirtusCloud Blob API."
api: "POST https://blob.virtuscloud.app/v1/objects"
authMethod: "none"
---
...
<ResponseField name="response" type="object">
  <Expandable title="Toggle object">
    ...
    <ResponseField name="url" type="string">
      The URL of the uploaded file. (File distributed in VirtusCloud CDN)
    </ResponseField>
  </Expandable>
</ResponseField>
