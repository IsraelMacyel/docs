...
description: "This documentation provides a comprehensive overview of the GET /v1/stats endpoint of the VirtusCloud Blob API."
api: "GET https://blob.virtuscloud.app/v1/account/stats"
authMethod: "none"
---
