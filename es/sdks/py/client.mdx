...
> The central object is the Client object, instantiated with an API key. This object represents a connection to the Virtus Cloud service and acts as an interface to interact with various aspects of the service.
