...
description: "In this section, you will learn how to manage databases using the Python SDK. Create, retrieve, update, delete, and monitor databases for your applications."
---
