---
title: "Listeners"
description: "Learn how to use listeners in your application using the virtuscloud python sdk."
---
...
from virtuscloud import Endpoint
...
async def main():
    client = virtus.Client('your api key')
...
<Accordion title="Additional information about this decorator">
    ...
    only a `response` parameter (of type `virtuscloud.http.Response`) will
    be returned.
</Accordion>
<Tip>
...
The "request listeners" do pretty much the same thing. But here you use the [Client], and the return of all endpoints is `virtuscloud.http.Response` objects.
...
_This implementation was inspired by a [suggestion](https://github.com/virtuscloudofc/sdk-api-py/pull/1) made by [@Mudinho](https://github.com/zRickz), thank you for contributing._
