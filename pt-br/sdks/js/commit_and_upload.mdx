...
description: "In this section you will learn how to make commits and uploads using the VirtusCloud JavaScript SDK."
---
...
<Tabs>
    ...
    const api = new VirtusCloudAPI("Your API Key");
...
`application.create()` is a method that allows you to upload a application to VirtusCloud.
...
configuration file, take a look at this [guide](https://docs.virtuscloud.app/getting-started/config-file).