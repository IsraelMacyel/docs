...
<Note>In VirtusCloud all projects are configured to auto load .env files.</Note>
...
<Note> VirtusCloud support for Node.js 20 is arrived on October 24, 2023. </Note>
...
That's all for now, an article written by João Otávio Stivi, CTO at VirtusCloud.