...
<ResponseField name="response" type="array">
  ...
  <Expandable title="Toggle object">
    <ResponseField name="name" type="string">
      The id of your Database hosted on Virtus Cloud.
    </ResponseField>
...
<Note>The format of the URL to download the desired snapshot is: [https://snapshots.virtuscloud.app/databases/\{accountID}/\{name}.zip?\{key}](https://snapshots.virtuscloud.app/databases/\{accountID}/\{name}.zip?\{key})</Note>
