...
## When does it occur?
When you are trying to connect your Lavalink server to your app hosted on VirtusCloud, you may come across the following error:
...
Congratulations! You have successfully solved the Lavalink Closed Abnormally issue. Now you can connect your Lavalink to your app hosted on VirtusCloud. 
