...
<div className="relative">
  ...
  <div className="px-4 max-w-6xl mx-auto mt-16 lg:mt-24">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
      <ServicesCard src="/images/services/bots.png" title="Bot Hosting" description="Host bots for Discord, Telegram and more, with high availability and low latency." href="/en/services/bots" />

      <ServicesCard src="/images/services/sites.png" title="Websites & APIs" description="Deploy your sites and APIs with support for the most popular frameworks in the market." href="/en/services/sites" />

      <ServicesCard src="/images/services/blob.png" title="Blob Storage" description="Serverless object storage with infinite scalability." href="/en/services/blob" />
    </div>
