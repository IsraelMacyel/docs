---
title: "Como Hospedar Aplicações Django"
sidebarTitle: "Django"
description: "Aprenda como criar e hospedar aplicações Django na Virtus Cloud."
---

# How to Host Django Applications

> Learn how to create and host Django applications on Virtus Cloud.
...
<Note>
  If you have a Django project that needs to apply migrations, make sure to apply them before deploying to Virtus Cloud.\
...
For more information about Django and its tools, visit the [official Django documentation](https://docs.djangoproject.com/en/5.0/).
There, you will find detailed guides, tutorials, and API documentation to help you make the most of Django.
