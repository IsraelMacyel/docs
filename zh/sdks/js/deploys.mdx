...
`app.deploys` exposes the [`DeploysModule`](https://github.com/virtuscloudofc/sdk-api-js/blob/main/src/modules/deploys.ts), which covers both the deploy timeline and the two GitHub integration paths.
